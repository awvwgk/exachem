...
public:
  // Constructor
  CCSD_T_Fused_Doubles2()  = default;
  ~CCSD_T_Fused_Doubles2() = default;

  // Copy constructor
  CCSD_T_Fused_Doubles2(const CCSD_T_Fused_Doubles2&) = default;
  // Copy assignment operator
  CCSD_T_Fused_Doubles2& operator=(const CCSD_T_Fused_Doubles2&) = default;

  // Move constructor
  CCSD_T_Fused_Doubles2(CCSD_T_Fused_Doubles2&&) = default;
  // Move assignment operator
  CCSD_T_Fused_Doubles2& operator=(CCSD_T_Fused_Doubles2&&) = default;
  ...
  void ccsd_t_data_d2_new(bool is_restricted,
                          ...
                          size_t t_p4b, size_t t_p5b, size_t t_p6b, size_t max_d2_kernels_pertask,
                          //
  ...
  void ccsd_t_data_d2_info_only(bool is_restricted, const Index noab, const Index nvab,
    ...
    for(auto ia6 = 0; ia6 < 9; ia6++) {
      ...
      for(Index p7b = noab; p7b < noab + nvab; p7b++) {
        ...
        // noab][4], detailed_stats[p7b - noab][5], detailed_stats[p7b - noab][6],
        // detailed_stats[p7b
...
void ccsd_t_data_d2_new(bool is_restricted,
                        ...
                        LRUCache<Index, std::vector<T>>& cache_d2t,
                        LRUCache<Index, std::vector<T>>& cache_d2v) {
  CCSD_T_Fused_Doubles2<T> ccsd_t_obj;
  ccsd_t_obj.ccsd_t_data_d2_new(is_restricted, noab, nvab, k_spin, d_t1, d_t2, d_v2, k_evl_sorted,
                                k_range, t_h1b, t_h2b, t_h3b, t_p4b, t_p5b, t_p6b,
                                max_d2_kernels_pertask, size_T_d2_t2, size_T_d2_v2, df_T_d2_t2,
                                df_T_d2_v2, host_d2_size_p7b, df_simple_d2_size, df_simple_d2_exec,
                                df_num_d2_enabled, cache_d2t, cache_d2v);
}
...
void ccsd_t_data_d2_info_only(bool is_restricted, const Index noab, const Index nvab,
                              ...
                              int* num_enabled_kernels, size_t& comm_data_elems) {
  CCSD_T_Fused_Doubles2<T> ccsd_t_obj;
  ccsd_t_obj.ccsd_t_data_d2_info_only(is_restricted, noab, nvab, k_spin, k_evl_sorted, k_range,
                                      t_h1b, t_h2b, t_h3b, t_p4b, t_p5b, t_p6b, df_simple_d2_size,
                                      df_simple_d2_exec, num_enabled_kernels, comm_data_elems);
}
